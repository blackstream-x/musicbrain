...
def main(arguments):
    ...
    musicbrainzngs.set_useragent(
        "get_release", "0.1.0", "https://github.com/blackstream-x/musicbrain"
    )
    ...
    print(
        "%s – %s"
        % (release_data["artist-credit-phrase"], release_data["title"])
    )
    ...
    for medium_data in release_data["medium-list"]:
        print(
            "Medium #%s (%s)"
            % (medium_data["position"], medium_data["format"])
        )
